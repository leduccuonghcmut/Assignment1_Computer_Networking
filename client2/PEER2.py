...
class PEER_FE(ctk.CTk):
  ...
  def mainPage(self):
    ...
    frame_label = ctk.CTkLabel(self.frameMainPage, text="WELCOM CLIENT 2", font=("Arial", 40, "bold"))
  ...
  def executeDownloadButton(self):
        ...
        header_upload = ctk.CTkLabel(self.frameExecuteDownloadButton, text="DOWNLOAD FILE: CLIENT 2", font=("Arial", 40, "bold"))
...
class PEER_BE():
  ...
  def listenForQuitKey(self):
    while True:
        if keyboard.is_pressed('w'):  # Nếu phím 'w' được bấm
