...
class PEER_FE(ctk.CTk):
  ...
  def mainPage(self):
    ...
    frame_label = ctk.CTkLabel(self.frameMainPage, text="WELCOM CLIENT 3", font=("Arial", 40, "bold"))
  ...
  def executeDownloadButton(self):
        ...
        header_upload = ctk.CTkLabel(self.frameExecuteDownloadButton, text="DOWNLOAD FILE: CLIENT 3", font=("Arial", 40, "bold"))
